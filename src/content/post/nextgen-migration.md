...
- 팀 전체 도입에는 공감대가 형성되지 않아 정착에 이르지 못했지만, 제안 과정에서 리뷰 문화의 필요성을 구체적으로 정리하고 공유하는 경험을 했습니다.
- 이후 GS리테일 이직 후에는 PR 리뷰를 일상적으로 주고받으며, 코드 리뷰가 결함 발견보다 서로 배우는 과정임을 직접 체감했습니다.
